...
main:
	...
	j Final_End				#jump to Final_End to end the program
...
String_Over:
	...
	addi $s2,$s2,2				#adding 2 in $s2 because at the when String_Over is executed,$s0=base address+2,in order to check that 
						#whether only the first char is null or there's is no input present at all
